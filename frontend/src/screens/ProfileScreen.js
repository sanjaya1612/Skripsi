...
const ProfileScreen = ({ history }) => {
    ...
    // const { loading: loadingOrdersMy, error: errorOrdersMy, myorders } = orderListMy
    ...
    return <Row>
        <>
            ...
            <Col md={9}>
            <img className="w-75" src='/images/profile.svg' alt="" />
            </Col>
            {/* <Col md={9}>
                ...
                {loadingOrdersMy ? <Loader /> : errorOrdersMy ? <Message variant='danger'>{errorOrdersMy}</Message> : (
                    <Table striped bordered hover responsive className='table-sm'>
                        <thead>
                            <tr>
                                <th>ID</th>
